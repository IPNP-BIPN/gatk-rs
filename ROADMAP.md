...
| **gatk-rs** | 202 tools | 5 crates, **33 conformance suites, all oracle-backed**; 1 tool byte-identical, and the annotation archetype opened with 35 of 54 annotations measured |
...
- [~] the 54-annotation library. **Thirty-five** are ported and oracle-backed: the counting family
      ...
      (`QD`, the genotype summaries, `LikelihoodRankSum`), together with the
...
- [ ] the remaining 19. **The claim that most of them wait on jmath does not survive a grep**: 10
