...
| **gatk-rs** | 202 tools | 5 crates, **33 conformance suites, all oracle-backed**; 1 tool byte-identical, and the annotation archetype opened with 32 of 54 annotations measured |
...
- [~] the 54-annotation library. **Thirty-two** are ported and oracle-backed: the counting family
      ...
      `HMER_INDEL_NUC`, the motifs, `GC_CONTENT`, `CYCLESKIP_STATUS`), together with the
...
- [ ] the remaining 22. **The claim that most of them wait on jmath does not survive a grep**: 10
