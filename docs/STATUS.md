...
## gatk-origin tools (77 of 202 started)
...
| `PrintFileDiagnostics` | unclassified | golden-pending | print-file-diagnostics | 1 | not measured |
...
<details><summary>125 not started</summary>
