...
| state | tools | share |
|---|---:|---:|
| oracle-backed | 124 | 39.9% |
| golden-pending | 1 | 0.3% |
| unchecked | 12 | 3.9% |
| not started | 174 | 55.9% |
| **total** | **311** | |
...
## gatk-origin tools (78 of 202 started)
...
| `CompareReferences` | reference-utility | golden-pending | compare-references | 1 | not measured |
