...
| state | tools | share |
|---|---:|---:|
| oracle-backed | 92 | 29.6% |
| golden-pending | 1 | 0.3% |
| unchecked | 12 | 3.9% |
| not started | 206 | 66.2% |
| **total** | **311** | |
...
## gatk-origin tools (62 of 202 started)
...
| `CompareIntervalLists` | unclassified | golden-pending | compare-interval-lists | 1 | not measured |
...
<details><summary>140 not started</summary>
