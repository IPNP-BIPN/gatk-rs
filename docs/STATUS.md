...
## gatk-origin tools (51 of 202 started)

| tool | archetype | state | suites | cases | argument coverage |
|---|---|---|---|---:|---|
| `ASEReadCounter` | locus-walker | golden-pending | ase-read-counter | 1 | not measured |
...
<details><summary>151 not started</summary>
