...
| state | tools | share |
|---|---:|---:|
| oracle-backed | 64 | 20.6% |
| golden-pending | 0 | 0.0% |
| unchecked | 12 | 3.9% |
| not started | 235 | 75.6% |
| **total** | **311** | |
...
## gatk-origin tools (33 of 202 started)
...
| `SelectVariants` | variant-transform | oracle-backed | select-variants-filters, select-variants-output, select-variants-samples, select-variants-subset | 4 | not measured |
