...
| state | tools | share |
|---|---:|---:|
| oracle-backed | 74 | 23.8% |
| golden-pending | 1 | 0.3% |
| unchecked | 12 | 3.9% |
| not started | 224 | 72.0% |
| **total** | **311** | |
...
## gatk-origin tools (44 of 202 started)
...
| `FilterMutectCalls` | variant-transform | golden-pending | filter-mutect-calls | 1 | not measured |
