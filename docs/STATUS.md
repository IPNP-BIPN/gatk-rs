...
| state | tools | share |
|---|---:|---:|
| oracle-backed | 97 | 31.2% |
| golden-pending | 1 | 0.3% |
| unchecked | 12 | 3.9% |
| not started | 201 | 64.6% |
| **total** | **311** | |
...
## gatk-origin tools (67 of 202 started)
...
| `CombineSegmentBreakpoints` | unclassified | golden-pending | combine-segment-breakpoints | 1 | not measured |
