...
| state | tools | share |
|---|---:|---:|
| oracle-backed | 144 | 46.3% |
| golden-pending | 1 | 0.3% |
| unchecked | 12 | 3.9% |
| not started | 154 | 49.5% |
| **total** | **311** | |
...
## gatk-origin tools (97 of 190 started)
...
| `GeneExpressionEvaluation` | locus-walker | golden-pending | gene-expression-evaluation | 1 | not measured |
