...
| `CountVariants` | variant-walker | oracle-backed | count-variants, sequence-dictionary-validation, tool-argument-declarations, tool-argument-enums | 4 | t=2, 24/24 rows (100%) |
