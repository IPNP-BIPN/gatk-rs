...
| state | tools | share |
|---|---:|---:|
| oracle-backed | 83 | 26.7% |
| golden-pending | 1 | 0.3% |
| unchecked | 12 | 3.9% |
| not started | 215 | 69.1% |
| **total** | **311** | |
...
## gatk-origin tools (53 of 202 started)
...
| `GetNormalArtifactData` | locus-walker | golden-pending | normal-artifact-data | 1 | not measured |
