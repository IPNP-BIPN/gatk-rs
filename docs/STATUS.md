...
## gatk-origin tools (40 of 202 started)
...
| `AnnotateVcfWithExpectedAlleleFraction` | variant-walker | golden-pending | annotate-vcf-with-expected-allele-fraction | 1 | not measured |
