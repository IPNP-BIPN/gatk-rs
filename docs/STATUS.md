...
| state | tools | share |
|---|---:|---:|
| oracle-backed | 73 | 23.5% |
| golden-pending | 0 | 0.0% |
| unchecked | 12 | 3.9% |
| not started | 226 | 72.7% |
| **total** | **311** | |
...
## gatk-origin tools (42 of 202 started)
...
| `Concordance` | variant-walker | oracle-backed | concordance-filter-analysis, concordance-summary | 2 | not measured |
