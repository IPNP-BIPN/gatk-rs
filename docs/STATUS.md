...
| state | tools | share |
|---|---:|---:|
| oracle-backed | 117 | 37.6% |
| golden-pending | 1 | 0.3% |
| unchecked | 12 | 3.9% |
| not started | 181 | 58.2% |
| **total** | **311** | |
...
## gatk-origin tools (74 of 202 started)
...
| `IndexFeatureFile` | unclassified | golden-pending | index-feature-file | 1 | not measured |
