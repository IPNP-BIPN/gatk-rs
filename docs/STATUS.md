...
## gatk-origin tools (21 of 202 started)
...
| `SplitNCigarReads` | record-transform | golden-pending | split-n-cigar-reads | 1 | not measured |
...
<details><summary>181 not started</summary>
