...
| state | tools | share |
|---|---:|---:|
| oracle-backed | 122 | 39.2% |
| golden-pending | 1 | 0.3% |
| unchecked | 12 | 3.9% |
| not started | 176 | 56.6% |
| **total** | **311** | |
...
## gatk-origin tools (76 of 202 started)
...
| `CalculateAverageCombinedAnnotations` | unclassified | golden-pending | calculate-average-combined-annotations | 1 | not measured |
