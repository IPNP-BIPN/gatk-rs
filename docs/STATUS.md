...
| state | tools | share |
|---|---:|---:|
| oracle-backed | 95 | 30.5% |
| golden-pending | 1 | 0.3% |
| unchecked | 12 | 3.9% |
| not started | 203 | 65.3% |
| **total** | **311** | |
...
## gatk-origin tools (65 of 202 started)
...
| `TagGermlineEvents` | unclassified | golden-pending | tag-germline-events | 1 | not measured |
...
<details><summary>137 not started</summary>
