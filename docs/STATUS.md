...
| state | tools | share |
|---|---:|---:|
| oracle-backed | 151 | 48.6% |
| golden-pending | 1 | 0.3% |
| unchecked | 12 | 3.9% |
| not started | 147 | 47.3% |
| **total** | **311** | |
...
## gatk-origin tools (104 of 190 started)
...
| `SVConcordance` | sv-caller | golden-pending | sv-concordance | 1 | not measured |
