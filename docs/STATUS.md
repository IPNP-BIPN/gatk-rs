...
| state | tools | share |
|---|---:|---:|
| oracle-backed | 42 | 13.5% |
| golden-pending | 1 | 0.3% |
| unchecked | 12 | 3.9% |
| not started | 256 | 82.3% |
| **total** | **311** | |
...
## gatk-origin tools (12 of 202 started)
...
| `PrintReadsHeader` | record-transform | golden-pending | print-reads-header | 1 | not measured |
