...
| state | tools | share |
|---|---:|---:|
| oracle-backed | 52 | 16.7% |
| golden-pending | 1 | 0.3% |
| unchecked | 12 | 3.9% |
| not started | 246 | 79.1% |
| **total** | **311** | |
...
## gatk-origin tools (22 of 202 started)
...
| `MethylationTypeCaller` | record-transform | golden-pending | methylation-type-caller | 1 | not measured |
