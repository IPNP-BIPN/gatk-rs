...
## gatk-origin tools (59 of 202 started)
...
| `ValidateBasicSomaticShortMutations` | variant-walker | golden-pending | validate-basic-somatic-short-mutations | 1 | not measured |
