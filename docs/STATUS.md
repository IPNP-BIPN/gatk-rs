...
| state | tools | share |
|---|---:|---:|
| oracle-backed | 84 | 27.0% |
| golden-pending | 1 | 0.3% |
| unchecked | 12 | 3.9% |
| not started | 214 | 68.8% |
| **total** | **311** | |
...
## gatk-origin tools (54 of 202 started)
...
| `CallCopyRatioSegments` | cnv-segmentation | golden-pending | call-copy-ratio-segments | 1 | not measured |
